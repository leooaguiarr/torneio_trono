...
import { getLocationRoast, getDeterministicFunnyNickname } from '../utils/funnyTitles';
    ...
    <div className="space-y-4 sm:space-y-5">
      ...
      {currentUser ? (
        ...
        >
          ...
          <span>ENTRAR COM GOOGLE PARA PONTUAR</span>
        </button>
      )}

      {/* Period Selector Tabs */}
      <div className="bg-white p-2 rounded-2xl border border-stone-200 shadow-xs flex items-center justify-between gap-2">
      ...
      {leader && (
        <div className="bg-amber-50 border-2 border-amber-300 rounded-2xl p-3.5 flex items-center justify-between gap-3 shadow-xs">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 flex-wrap">
                <span className="text-xs font-black bg-amber-300/80 text-stone-950 px-1.5 py-0.5 rounded">
                  "{leader.participant.nickname || getDeterministicFunnyNickname(leader.participant.id)}"
                </span>
      ...
      {rankings.length === 0 ? (
        ...
        <div className="space-y-3">
          {rankings.map((rank, index) => {
            ...
            const funnyNickname =
              rank.participant.nickname || getDeterministicFunnyNickname(rank.participant.id || rank.participant.name);
            ...
            return (
              <div
                ...
                className={`bg-white rounded-2xl border transition-all p-3.5 sm:p-4 shadow-xs flex flex-col gap-2.5 ${
              ...
              >
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2.5 sm:gap-3 min-w-0 flex-1">
                    ...
                    <div className="w-10 h-10 rounded-xl bg-stone-100 border border-stone-200 flex items-center justify-center text-xl shrink-0 overflow-hidden shadow-2xs">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        {/* Funny Nickname Badge placed prominently in front */}
                        <span className="text-[10px] font-black bg-stone-900 text-amber-400 px-1.5 py-0.5 rounded uppercase tracking-wider shrink-0">
                          {funnyNickname}
                        </span>
                      ...
                      <h4 className="font-bold text-sm sm:text-base text-stone-900 truncate mt-0.5">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <div className="text-right pr-1">
                      <span className="text-base sm:text-lg font-black text-stone-950 block leading-tight">
                    ...
                    {currentUser ? (
                      <>
                        <button
                          ...
                          className="px-3 py-2 sm:px-3.5 sm:py-2.5 rounded-xl font-black text-xs sm:text-sm bg-amber-400 hover:bg-amber-500 text-stone-950 border border-stone-900 shadow-2xs transition-all active:scale-95 flex items-center gap-1 cursor-pointer"
                ...
                <div className="bg-stone-50 rounded-xl p-2.5 sm:p-3 border border-stone-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 sm:gap-3 text-xs">
                  {/* Funny Roast Text */}
                  <div className="flex items-center gap-2 min-w-0">
                    <span className="text-lg shrink-0">{locationRoast.emoji}</span>
                  ...
                  {rank.totalCount > 0 && (
                    <div className="flex items-center gap-1.5 shrink-0 self-start sm:self-auto">
                      <span className="px-2 py-0.5 rounded-md bg-stone-200 text-stone-800 font-bold text-[11px]">
